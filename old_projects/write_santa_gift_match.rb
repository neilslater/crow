...
m = Crow::LibDef.new( 'sgm', {
  :structs => [
    { :name => 'child_wishlist',
      :attributes => [
        {:name =>'narr_items', :ruby_name => 'items', :ctype=>:NARRAY_INT_32, :ptr_cache => 'items', :rank_expr => '2', :shape_var => 'items_shape', :shape_exprs => [ '10', '1000000' ] },
        ],
      :init_params => []
    },
    ...
    { :name => 'gift_goodkids',
      :attributes => [
        {:name =>'narr_items', :ruby_name => 'items', :ctype=>:NARRAY_INT_32, :ptr_cache => 'items', :rank_expr => '2', :shape_var => 'items_shape', :shape_exprs => [ '1000', '1000' ] },
      ],
      :init_params => []
    },
    ...
    { :name => 'scores',
      :attributes => [
        {:name =>'narr_table', :ruby_name => 'table', :ctype=>:NARRAY_INT_16, :ptr_cache => 'table', :rank_expr => '2', :shape_var => 'table_shape', :shape_exprs => [ '1000', '1000000' ] },
      ],
      :init_params => []
    },
