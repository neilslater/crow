...
m = Crow::LibDef.new('stolen_sleigh', {
                       structs: [
                         { name: 'input',
                           attributes: [
                             { name: 'narr_gifts', ruby_name: 'gifts', ctype: :NARRAY_DOUBLE, ptr_cache: 'gifts', rank_expr: '2', shape_var: 'gifts_shape', shape_exprs: %w[4 100000] }
                           ],
                           init_params: [] },

                         { name: 'solution',
                           attributes: [
                             { name: 'narr_items', ruby_name: 'items', ctype: :NARRAY_INT_32, ptr_cache: 'items', rank_expr: '2', shape_var: 'items_shape', shape_exprs: %w[2 100000] }
                           ],
                           init_params: [] },
