  ...
  describe 'create' do
    ...
    context 'initialisation' do
      it 'can accept arbitrary initialisation' do
        typemap = Crow::TypeMap.create('x', ctype: :int, parent_struct: container, init: { init_expr: 'frobnicate()' })
      ...
      it 'can refer other parameters from the same struct using %' do
        ...
        typemap = Crow::TypeMap.create('x', ctype: :int, parent_struct: container, init: { init_expr: '%y' })
      ...
      it 'can accept self-referential init param "."' do
        ...
        typemap = Crow::TypeMap.create('y', ctype: :int, parent_struct: container, init: { init_expr: '.' })
